...
public class PasswordUtil {
    ...
    public static String hashPassword(String password) {
        try {
            ...
            for (byte b : hashedBytes) {
                sb.append(String.format("%02x", b)); // format to hex
            }
            return sb.toString();
     ...
     *
     * @param password   the plain password entered by user
     * @param dbPassword the stored hashed password from DB
     * @return true if matched, false otherwise
     */
    public static boolean verifyPassword(String password, String dbPassword) {
        String hashedInput = hashPassword(password);
        return hashedInput.equals(dbPassword);
    }
